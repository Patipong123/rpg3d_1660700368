...
public abstract class Characters : MonoBehaviour
{
    ...
    public void CharInit(VFXManager vfxM, UIManager uiM, InventoryManager invM, PartyManager partyM) 
    {
        ...
        inventoryItem = new Item[InventoryManager.MAXSLOT];
    }
    ...
    protected virtual void Die() 
    {
        ...
        invManager.SpawnDropInventory(inventoryItem, transform.position);
    ...
    {
        if (vfxManager != null)
            vfxManager.ShootMagic(curMagicCast.ShootId, transform.position,
                                   curCharTarget.transform.position, curMagicCast.ShootTime);
